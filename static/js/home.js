...
(function ($) {
  jQuery(document).ready(function () {
    ...
    */
    ...
    var hLines = document.getElementById("experiences-section").getElementsByClassName("horizontal-line");
    ...
    // ============== Fix Timelines Horizontal Lines =========
    var hLines = document.getElementById("education-section").getElementsByClassName("horizontal-line");
    for (let i = 0; i < hLines.length; i++) {
      if (i % 2) {
        hLines[i].children[0].children[0].classList.add("bottom-right");
        hLines[i].children[2].children[0].classList.add("top-left");
    ...
    var vLines = document.getElementById("experiences-section").getElementsByClassName("vertical-line");
    ...
    // ============== Fix Timelines Vertical lines =========
    var vLines = document.getElementById("education-section").getElementsByClassName("vertical-line");
    for (let i = 0; i < vLines.length; i++) {
      if (i % 2) {
        vLines[i].classList.add("vertical-line-left-adjustment");
      }
